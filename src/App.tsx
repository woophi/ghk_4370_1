...
const data = [
  {
    ...
    img: ya,
    analytics: '4370_yandex_eda_var1',
  },
  {
    title: 'Бигфест',
    titleRight: 'до 50%',
  ...
  },
  {
    ...
    subtitle2: '',
    img: klv,
    analytics: '4370_cuulklever_var1',
  },
  {
    title: 'Яндекс Лавка',
    titleRight: '500₽',
    ...
    subtitle2: 'До 28 февраля',
    img: lav,
    analytics: '4370_yandex_lavka_var1',
  },
];
...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '4370_map_var1');
    setLoading(true);
